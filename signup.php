    ...
    <body style="background-image:url('./images/inbg.jpg');">
        ...
        <div id="ddown">
            ...
            <center><p>©2019, Adewale Ibrahim College of Health Sciences. Design and Developed with ♥ by <a href="https://jeffrey.myethion.com" target="_blank">ETHION</a></p></center>
             ...
             <div id="drig">
                 <br>
            <center><font style="color:black; margin-left:0px; font-size:22px; font-family: verdana;font-weight: bold;">Sign Up to Apply Online!</font></center>
                    <table id="tabintro">
                <tr>
                    <td>
                    <font style="color:black; margin-left:30px; font-family: Verdana;  margin-top:15px; font-size:17px;">Full Name: * </font>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                 ...
                 <tr>
                    <td>
                       <font style="color:black; margin-left:30px; font-family: Verdana;font-size:17px;" required> Email: * <font>
                    </td>
                 </tr>
                 <tr>
                    <td  style="padding-bottom: 1em;">
                ...
                <tr>
                    <td>
                       <font style="color:black; margin-left:30px; font-family: Verdana;font-size:17px;" required> Phone: *<font>
                    </td>
                 </tr>
                 <tr>
                    <td  style="padding-bottom: 1em;">
                ...
                <tr>
                    <td  style="padding-bottom: 1em;">
                        ...
                        <br><input type="submit" id="in_sub" name="in_sub" onclick="validate();"  value="SIGN UP"  style="margin-top: 8px;margin-left:90px;" class="toggle btn btn-primary">
