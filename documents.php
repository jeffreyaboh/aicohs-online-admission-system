        ...
        <form id="docup" enctype="multipart/form-data" name="docup" action="documents.php" method="post">
            ...
            <table class="table table-striped">
                            <thead>
                                       <tr>
                                           <th >
                                       <font style=" font-family: Verdana;  font-size:19px;"> Upload Your Documents (You can skip this step by clicking 'Proceed')</font>
                                           </th>
                                        </tr>           
                            </thead>
                            <tbody>
                            <tr>
                             ...
                             <tr>
                                <td>O'Level Result (WAEC, NECO or NABTEB) :</td>
                                <td>
                             ...
                             <tr>
                                 <td>
                                Additional O'Level Result (If Any) :
                                 </td>
                                 <td>
                            ...
                            <tr>
                                <td>
                                    Application Fee Bank Receipt (If Paid Directly to Bank) :
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="2"><p><b>NB</b>: Ensure to click the submit button to save documents.</p><br><input type="submit" id="fpicup" name="fpicup" class="toggle btn btn-primary"></td>
                            </tr>
              ...
              <center> <div class="jumbotron" style="width:100%; box-shadow: -3px 3px 10px #999999;   margin-top:10px;">
                      <h3>
                          <b> <font style=" font-family: Verdana;  font-size:19px;"> Declaration By The Applicant</font></b>
                           ...
                           <input type="checkbox" id="dec" name="dec" value="Proceed" onclick="send()"><font style=" font-family: Verdana;font-size:medium">
                           Proceed</font>
